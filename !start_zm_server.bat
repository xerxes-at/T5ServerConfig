...
:server
start /wait /abovenormal bin\plutonium-bootstrapper-win32.exe t5sp "%gamepath%" -dedicated +set key %key% +set fs_game %mod% +exec %cfg% +set net_port %port% +start_map_rotate
