...
:server
start /wait /abovenormal bin\plutonium-bootstrapper-win32.exe t5mp "%gamepath%" -dedicated +set key %key% +set fs_game "%mod%" +exec "%cfg%" +set net_port %port% +set sv_maxclients %maxclients% +start_map_rotate
